//使用方式：frida -U -f com.kugou.kugou1002 -l Tools/hook_sub10xx.js
// 或：frida -D fa6f4e5a190858ab2441952057f189eb5c15b595 -f com.kugou.kugou1002 -l Tools/hook_sub_10xx.js
...
// var f = addr.add(0x10CD967F0);   // sub_107C0A718 = 0x107C0A718
...
var addr = Module.findBaseAddress("kugou"); 
var f = addr.add(0x10CD967F0);   // sub_10CD967F0 = 0x10CD967F0
Interceptor.attach(f, {
    onEnter(args) {
        const dict = new ObjC.Object(args[0]);
        const key = new ObjC.Object(args[1]);
    ...
    onLeave(retval) {
        const object = new ObjC.Object(retval);
        console.log("sub_10CD967F0 ret=", object.toString());
    }
});