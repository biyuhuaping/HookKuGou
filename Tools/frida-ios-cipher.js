// frida -Up 1590 -l frida-ios-cipher.js -o out.json
// 运行：frida -U -f com.kugou.kugou1002 -l frida-ios-cipher.js -o out.json
//Frida iOS Cipher是一个开源的算法hook脚本，基本上市面上的app使用它都可以得到一个解决
