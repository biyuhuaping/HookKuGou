/*
 * Auto-generated by Frida. Please modify to match the signature of +[UICKeyChainStore stringForKey:service:].
...
defineHandler({
  onEnter(log, args, state) {
    log(`+[UICKeyChainStore stringForKey:${args[2]} service:${args[3]}]`);
