/*
 * Auto-generated by Frida. Please modify to match the signature of +[UICKeyChainStore stringForKey:service:accessGroup:].
...
defineHandler({
  onEnter(log, args, state) {
    log(`+[UICKeyChainStore stringForKey:${args[2]} service:${args[3]} accessGroup:${args[4]}]`);
