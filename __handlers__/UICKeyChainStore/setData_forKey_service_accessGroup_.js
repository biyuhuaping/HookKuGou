/*
 * Auto-generated by Frida. Please modify to match the signature of +[UICKeyChainStore setData:forKey:service:accessGroup:].
...
defineHandler({
  onEnter(log, args, state) {
    log(`+[UICKeyChainStore setData:${args[2]} forKey:${args[3]} service:${args[4]} accessGroup:${args[5]}]`);
